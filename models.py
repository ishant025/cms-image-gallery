...
class Tag(db.Model):
    ...
    # AI confidence score (0-100) for auto-generated tags; NULL for manual tags
    confidence = db.Column(db.Float, nullable=True)
    # Flag indicating if tag was auto-generated by AI (True) or manually added (False)
    ...
    def __repr__(self):
        return f"<Tag id={self.id} name={self.name!r} ai={self.is_ai_generated}>"
